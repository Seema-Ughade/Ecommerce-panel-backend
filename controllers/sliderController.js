...
// exports.createSlider = async (req, res) => {
//   try {
//     const { name, slug, subTitle, title, description, subTitleColor, titleColor, descriptionColor, link } = req.body;
//     let imageUrl = null;
...
//     const updatedSlider = await Slider.findByIdAndUpdate(
//       req.params.id,
//       { name, slug, subTitle, title, description, subTitleColor, titleColor, descriptionColor, image: imageUrl, link },
//       { new: true }
//     );
...
//     // If you want to delete the image from Cloudinary as well, uncomment the following lines:
//     // const publicId = deletedSlider.image.split('/').pop().split('.')[0];
